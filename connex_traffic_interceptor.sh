...
# 🕵️ CONNEX PRO VPN - INTERCEPTAÇÃO DE TRÁFEGO EM TEMPO REAL
# Versão: 1.0
...
print_header "CONNEX PRO VPN - INTERCEPTAÇÃO DE TRÁFEGO"
...
ps aux | grep -E "(connex|devws|pro)" > "$OUTPUT_DIR/process_monitoring/connex_processes.txt" 2>/dev/null || true
...

{
    ...
    FIREBASE_ENDPOINTS=(
        "https://firebase.googleapis.com/v1alpha/projects/dtunnel-ec825"
        "https://firebaseremoteconfig.googleapis.com/v1/projects/dtunnel-ec825/remoteConfig"
        "https://firebaseinstallations.googleapis.com/v1/projects/dtunnel-ec825/installations"
...
echo "🕵️ MONITOR CONTÍNUO - CONNEX PRO VPN"
echo "===================================="
...
🕵️ CONNEX PRO VPN - RELATÓRIO DE ANÁLISE DE TRÁFEGO
===================================================
...
$(cat "$OUTPUT_DIR/process_monitoring/connex_processes.txt" 2>/dev/null | wc -l) processos relacionados encontrados
