...
class LiberaNetInteractiveBot:
    def __init__(self, token):
        ...
        # Setup menu button on first message
        self.menu_button_setup = False
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # Setup menu button on first interaction
        if not self.menu_button_setup:
            await self.setup_menu_button()
            self.menu_button_setup = True
...
📧 Email: vendas@liberanet.online
🌐 Site: www.liberanet.online
...
🔥 **CONTATO DIRETO:**
• 📱 WhatsApp: +55 11 99999-9999
• 📧 Email: suporte@liberanet.online
• 🌐 Site: www.liberanet.online
...
"""
        ...
        try:
            ...
            if payment_result:
                ...
                # Store payment info in memory (temporary)
                ...
                # Use the new copy-paste PIX format
                success_message = format_pix_for_copy_paste(payment_result, PROMO_PRICE)
        ...
        try:
            ...
            if status:
                if status.get('status') == 'paid':
                    ...
                    db.update_payment_status(payment_info['payment_id'], 'paid')
                    db.add_user(user_id, subscription_status='active')  # Activate subscription
...
"""
    ...
    def run(self):
        ...
        # Run the bot using the built-in polling method
